...
const CreatePost = () => {
  ...
  const {  loadPosts , createPost} = Authentication()
  ...
  return (
    <div className="p-20  h-screen mb-8 m-4">
      ...
      <div className="flex flex-col  gap-4  mx-auto  md:flex-row ">
        ...
        <div className='flex flex-col gap-1  flex-1'>
          ...
          <div className="flex flex-col flex-1">
            <h2 className="text-xl font-semibold text-gray-800 mb-2">
              ...
              <input  id="name" name="name" placeholder="Name..." onChange={handleChange}  className='border border-gray-300 h-10 px-3 rounded focus:outline-none focus:ring-2 focus:ring-blue-400'/>
         ...
         <div className="bg-white p-6 rounded-xl flex flex-col gap-4">
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Post</h2>
                <input
                  type="file"
                  id="banner"
                  name="banner"
        ...
        { loadPosts && <div className="w-5 h-5 border-4 border-white border-t-transparent rounded-full animate-spin" />   
         }
         <span>Post</span>
